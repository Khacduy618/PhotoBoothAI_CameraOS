...
2. `docs/architecture/MomentAI_Guest_Internal_System_Design.md` for Guest Flow V3 architecture and product intent
3. `docs/product/GUEST_FLOW_V3_DELIVERY_PLAN.md` for execution order
4. `docs/product/GUEST_FLOW_V3_ROLE_TASK_MATRIX.md` for story ownership and role handoffs
5. `docs/testing/GUEST_FLOW_V3_ACCEPTANCE_EVIDENCE_MATRIX.md` for required evidence
6. `docs/product/GUEST_FLOW_V3_BACKLOG.md` for story acceptance criteria
7. `.opencode/rules/*`
...
- Do not skip ahead to later milestone work without explicit PM approval.
- Guest Flow V3 implementation follows the milestones in `docs/product/GUEST_FLOW_V3_DELIVERY_PLAN.md`.
- Work one approved story or tightly-related story group at a time.
- Do not introduce features from future backlog while implementing Guest Flow V3 foundations.
