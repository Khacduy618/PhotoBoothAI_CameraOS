...
export const SelectPrintQuantityScreen: React.FC<SelectPrintQuantityScreenProps> = ({
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-between p-6 sm:p-10 bg-[#FDFCFB] text-[#1A1A1A] select-none overflow-y-auto">
      ...
      {/* Options Grid */}
      <div className="w-full max-w-6xl mx-auto my-auto py-6 grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6 items-stretch">
        ...
        <motion.div
          ...
          className="min-h-[220px] lg:min-h-[380px] p-6 border-2 border-[#1A1A1A]/15 bg-[#F4F2EE] rounded-sm flex flex-col justify-center text-center"
        >
          <span className="text-[11px] uppercase font-bold tracking-[0.22em] text-[#1A1A1A]/60">
            Tùy chỉnh
          </span>
          <span className="mt-3 font-serif text-2xl font-bold text-[#1A1A1A]">
            Số lượng in
          </span>
          ...
          <div className="mt-8 flex items-center justify-center gap-4">
            <button
              ...
              className="w-16 h-16 border border-[#1A1A1A]/30 bg-[#FDFCFB] text-[#1A1A1A] flex items-center justify-center rounded-full disabled:opacity-35 disabled:cursor-not-allowed hover:border-[#1A1A1A] transition-colors"
            >
              <Minus className="w-7 h-7" />
            </button>

            <div className="w-24 h-24 rounded-full bg-[#1A1A1A] text-[#FDFCFB] flex items-center justify-center font-serif text-5xl font-bold shadow-md" aria-live="polite">
              {clampedQuantity}
            </div>
          ...
          <div className="mt-5 border-t border-[#1A1A1A]/10 pt-5" aria-live="polite">
            <span className="block text-[10px] uppercase font-bold tracking-[0.2em] text-[#1A1A1A]/55">
              Tổng tiền
            </span>
            <span className="mt-1 block text-2xl font-bold text-[#1A1A1A] font-sans">
              {selectedTotalPrice}
            </span>
          </div>

          <p className="mt-4 text-xs leading-relaxed text-[#1A1A1A]/65">
      ...
      <div className="w-full max-w-4xl mx-auto pt-6 border-t border-[#1A1A1A]/10 flex items-center justify-between">
        ...
        <button
          onClick={() => onConfirmPrintQuantity(clampedQuantity)}
